            ...
            <section className="me">
                <button className="about"> About Me <img src={flecha} alt="flecha" className="flecha"/>
                    ...
                    <div className="openAbout">
                        ...
                        Me considero una persona pro activa, creativa, eficiente, flexible al cambio, resiliente, con capacidad de trabajo en equipo, consiente de mis tareas y responsabilidades propias del cargo que este ejecutando, dispuesta a aprender cada día y a compartir mis conocimientos en pro de cumplir metas personales y de la compañía.</p>
                    </div>
